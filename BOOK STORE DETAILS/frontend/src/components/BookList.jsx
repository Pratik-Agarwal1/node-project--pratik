...
const BookList = () => {
    ...
    const getBooks = async () => {
        try {
            const response = await axios.get("http://localhost:8000/books/getbook")
    ...
    const deleteBook = async (id) => {
        try {
            const response = await axios.delete(`http://localhost:8000/book/deleteBook/${id}`);
            if (response.status === 200) {
                                ...
                                <div className="card-actions justify-center">
                                    <Link to={`/book-form/${el._id}`}>
                                        <button 
                                            ...
                                            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#007b5e'}
                                        >
                                            Edit
                                        </button>
                                    </Link>
                                    <button 
                                        ...
                                        onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#b52b2b'}
